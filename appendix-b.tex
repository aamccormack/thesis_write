...
Find below table \ref{table:summary_stats} which details the summary statistics for the responses to the survey. Table \ref{table:variable to questions} contains the codified factor name and what questions they respond to.
...
\begin{table}[H]
    ...
    \hline
        factor & mean & Std Dev. & min & max & range & skew  \\ \hline
    ...
    \end{tabular}
    \caption{Summary Statistics - General Factors}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Summary Statistics - Connection to Research Sites Factors}
...
\begin{table}[H]
    ...
    \hline
        ...
        info\_climate\_edu & 0.29 & 0.46 & 0 & 1 & 1 & 0.89 \\ \hline
         ...
         \end{tabular}
    \caption{Summary Statistics - Information Access} {Factors for the questions  "Where do you get information about this place?" for factors starting with info\_place and "Where do you get information about climate change?" for factor starting with info\_climate.}
...
\begin{table}[H]
    ...
    \hline
        ...
        risk\_i\_storm\_total & 2.14 & 1.51 & 0 & 5 & 5 & 0.33 \\ \hline
          \end{tabular}
    \caption{Summary Statistics Perceived Risks}{for the responses to the questions "From the following what are the major risks to people in this area?" and "From the following what are the major risks to infrastructure in this area?".}
...
\begin{figure}[H]
    ...
    \caption{Social Media Post}{This is an example of the type of social media used to access stakeholders. A short video playing a loop of the simulated water level extremes in Nidelva was utilised to optimise algorithms which prioritise video.}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Poster}{This poster was printed on weather proof A4 card and placed in the research sites, focusing on locations where people wait.}
    \label{fig:poster}
\end{figure}
