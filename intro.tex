...
\paragraph{}
It was hypothesised that due to the changing climate, decreasing uplift rates (\cite{hanssen-bauer_climate_2017}) and social shifts (\cite{dsb_integrating-sea-level-rise-and-storm-surges--local-planningpdf_2017}) including increasing population in Trondheim that Trondheim will then decrease to quite resilient during the period of 2050 to 2100. 
\paragraph{}
