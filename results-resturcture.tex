...
\section{Awareness}
Figure 5.18 shows that the subjects displayed a high awareness of the tides in Trondheim. The height chosen largely corresponds with either the spring or neap high tide.
\begin{figure}[H]
    \centering
...
\end{figure}
\paragraph{}
 . Under 20 subjects responded with an answer which does not reflect the models from \cite{kartverket_se_2021}. Over 88 percent of subjects chose a value which matches with models by \cite{kartverket_se_2021} The majority of respondents chose the answer of 1.2m which corresponds with the spring tide. 
