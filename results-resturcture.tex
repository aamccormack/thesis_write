...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|l|}
    \hline
         ~ & \textbf{Awareness as predictor} & ~ & ~ \\ \hline
...
\begin{table}[H]
    ...
    \hline
       ...
       Factor & p value & h value & df & p value & h value & df \\ \hline
        ...
        \hline
    \end{tabular}
    \caption{Kruskal Wallis Test Results Variables on Information Sources for Place. Awareness All means that for this determination of awareness all five questions on awareness in the survey were included. Awareness Photo means that for this determination of awareness the three questions on awareness utilsing edited photographs were included}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Kruskal Wallis Test Results Variables on Information Sources for Climate. Awareness All means that for this determination of awareness all five questions on awareness in the survey were included. Awareness Photo means that for this determination of awareness the three questions on awareness utilising edited photographs were included}
    \label{Kruskal_wallis_test_information}
\end{table}
