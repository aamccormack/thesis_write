...
\begin{figure}[h!]
    ...
    \caption{Memory of Sea Level Extremes - 45 out of 153 subjects do not remember any sea level extreme event in Trondheim. Only one subject remembered every sea level extreme event dating back to 1950 in Trondheim. }
    \label{fig:my_label}
\end{figure}
\paragraph{}
