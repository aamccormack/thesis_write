...
\begin{table}[H]
    ...
    Mean - average, i.e. the total of the numbers, then divided by how many numbers there are. 
    Std Dev. - standard deviation. 
    Min - minimum, i.e. the smallest potential in this case representing an non-selected response hence 0.
    Max - maximum i.e the largest potential number, for the majority of factors this is 1, but for Sum of Information Access this is 8.
    Range - difference between the minimum and maximum i.e. the smallest and largest number
