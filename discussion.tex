...
The three systems of resilience have strong interactions. Distinguishing technological systems, from natural systems for the risk associated with sea level extremes, is particularly difficult in Trondheim due to the long history of the coastline being shaped by its population. Table 2.1 in the background  displays how each of the research sites coastline has been artificially altered. In general infrastructure on reclaimed land is more vulnerable to SLEs.
\paragraph{}

With current city organisation, only once SLEs reach the height of 269cm, which is the projection for the 20 year return height in 2090, is a critical building due to be impacted. This does not mean that there is no impact to infrastructure, but that it is unlikely to have a large negative impact on the technological systems in Trondheim ability to quickly return to normality for lower sea level extremes. However Trondheim Kommune city plans indicate that the research sites should be prepared for an SLE 4.87m by 2100 \cite{hanssen_saksframlegg_2013}.
\paragraph{}
Once 4m SLE is reached 1,162 buildings will be flooded, 5 of these being critical buildings. If the current organisation of Trondheim remains. 2100 is 82 years away and even then the likelihood of this level of flooding impacting the city is not very likely. Overall the technological resilience of the city for the period 2022 to 2050 is considered very high. The technological system resilience of the city for the period 2050 to 2100 is considered high. This is because even with the increased risk, the building regulations implemented in 2016 are preparing for this risk. They are not designed so that no new infrastructure will be flooded, but that it will not be too negatively impacted by the flooding. In other words it should be able to quickly return to normality. 
\paragraph{}
This is only possible for sites which are temporally flooded. By 2090 60 buildings in Trondheim are projected to be permanently flooded. These buildings are not considered as possessing resilience, but they are a small part of the overall technological system. The impact of this nuisance flooding and how it interacts with Norway's system of insurance is discussed in the section on risk perception. While these floods may have minimal effects on the technological system resilience they are likely to affect the economics of the sites, including due to impacts to insurance premiums (\cite{cutter_community_2020}). 
\paragraph{}
Other infrastructure in Trondheim is projected to be resilient to future SLEs, but the drainage network and tunnels are at greater risk (\cite{hanssen_saksframlegg_2013}). This is due to there lower, often subteranen position. The drainage network is perhaps the greatest weakness in the technoligical system resilience, but there is ongoing work to improve it ***cite**. This ongoing improvement again highlights the need for repeated measurement to understand a places trend in resileince.
\paragraph{}
...
\paragraph{}
Resilience will change as the city changes. Looking to city plans is helpful but repeated measurements of the changing resilience is key.

\section{Natural Systems Resilience}

T

It is projected that a sea level rise of -1 to +21 cm until the year 2050, and then a further sea level rise of 22 to 77 cm until the year 2100 will occur in Trondheim  (\cite{hanssen_saksframlegg_2013}). The main natural systems resilience impact is due to storm surges. These are expected to be particularly problematic due to them being exaggerated by Trondheimsfjord. While Trondheimsfjord currently gives Trondheim protection against storms washing in from the North sea, it may exaggerate the effects of storm surges (\cite{hanssen_saksframlegg_2013}). 
