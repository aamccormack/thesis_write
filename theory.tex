...
\begin{figure}[h!]
   ...
   (\cite{noaa_what_2023-1}).\paragraph{}
    ...
    Waves (blue) are created by energy passing through the water, this is due to several factors. For sea level extremes in Trondheim the most important factors are waves caused by the wind (Wind Waves) and waves changing due to the decreasing depth of the coast (Wave Runup) (\cite{dsb_integrating-sea-level-rise-and-storm-surges--local-planningpdf_2017};\cite{noaa_what_2023}).    
