...
\begin{figure}[h]
    ...
    \includegraphics[width=1\textwidth]{fig_theory/awareness lujala and whitmarsh.png}
     \caption{Awareness of Natural Hazard Risk to behaviour pipeline based of \cite{lujala_climate_2015}\cite{whitmarsh_are_2008}}
...
The conceptualisation here is influence by ....
\begin{figure} [h]
    \centering
    \includegraphics[width=1\textwidth]{fig_theory/cutter_2008.png}
    \caption{Cutter - probably cut but useful when im thinking}
    \label{fig:Cutter}
\end{figure}
