...
\begin{figure} [H]
    ...
    \caption[Research sites - Trondheim]{The sites chosen to investigate Trondheim are Brattøra, Grillstad, Skansen and Nidelva. These sites are highlighted with a purple circle. Figure was created using ArcGIS Pro.}
...
\begin{table}[!ht]
    ...
    \end{tabular}
    \caption{ Research Sites Changing Physical Vulnerability to SLEs}
