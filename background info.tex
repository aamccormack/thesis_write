...
Figures ~\ref{fig:sle_skansen_num} to ~\ref{fig:sle_nidelva_num}  display the mapped SLEs created for this thesis based off \cite{kartverket_se_2021} and \cite{stormflo_database_stormflo_2021}, in the research sites - Skansen, Brattøra, Grillstad and Nidelva.
